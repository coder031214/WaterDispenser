...
/* IO口操作函数 */
#define   Vehicle_light_Enable()         GPIO_ResetBits( Vehicle_light_GPIO_PORT, Vehicle_light_PIN )
#define   Vehicle_light_Disable()        GPIO_SetBits  ( Vehicle_light_GPIO_PORT, Vehicle_light_PIN )

#define   Vehicle_lift_Enable()         GPIO_ResetBits( Vehicle_lift_GPIO_PORT, Vehicle_lift_PIN )
#define   Vehicle_lift_Disable()        GPIO_SetBits  ( Vehicle_lift_GPIO_PORT, Vehicle_lift_PIN )

#define   Vehicle_right_Enable()         GPIO_ResetBits( Vehicle_right_GPIO_PORT, Vehicle_right_PIN )
#define   Vehicle_right_Disable()        GPIO_SetBits  ( Vehicle_right_GPIO_PORT, Vehicle_right_PIN )
